...
const todosLosProductos = [
    ...
    { id: 2, name: 'Timbres', imagen: timbre, size: 'M', price: 5000, stock: 20, description: 'Personalizados, engomado y de larga duración' },
    { id: 3, name: 'Tarjetero', imagen: tarjetero, size: 'Simple', price: 2000, stock: 10, description: 'Tarjetero de polipropileno.' }
]
